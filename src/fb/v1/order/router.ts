...
import { V1OrderNewBatchBetMatchMarketOfJumpLine } from "./batchBetMatchMarketOfJumpLine";
...
FbV1OrderRouter.post("/batchBetMatchMarketOfJumpLine",V1OrderNewBatchBetMatchMarketOfJumpLine);
